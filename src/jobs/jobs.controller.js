...
Get()(
  ...
  'getJobs',
  Object.getOwnPropertyDescriptor(JobsController.prototype, 'getJobs'),
);

Post()(
  JobsController.prototype,
  'createJob',
  Object.getOwnPropertyDescriptor(JobsController.prototype, 'createJob'),
);

Patch(':id/status')(
  JobsController.prototype,
  'updateJobStatus',
  Object.getOwnPropertyDescriptor(JobsController.prototype, 'updateJobStatus'),
);

Delete(':id')(
  JobsController.prototype,
  'deleteJob',
  Object.getOwnPropertyDescriptor(JobsController.prototype, 'deleteJob'),
);
